                        ...
                        <div class="main-nav d-none d-lg-block">
                            <nav class="site-navigation text-right text-md-center" role="navigation">
                                <ul class="site-menu js-clone-nav d-none d-lg-block">
                                    ...
                                    <li class="active"><a href="/load">CỬA HÀNG</a></li>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-12 mb-0">
                            ...
                            <a href="/load">Cửa Hàng</a> <span class="mx-2 mb-0">/</span>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <a href="/update?tid=${id}" class="btn btn-sm height-auto px-4 py-3 btn-primary">Chỉnh sửa</a>
                            <a href="/delete?tid=${id}" onclick="return confirm('Bạn có chắc muốn xóa sản phẩm này?');" class="btn btn-sm height-auto px-4 py-3 btn-primary delete-action">Xóa</a>
