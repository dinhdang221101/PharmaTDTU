...
<html lang="en">
        ...
        <main class="app-content">
            <div class="app-title">
                <ul class="app-breadcrumb breadcrumb">
                    <li class="breadcrumb-item">Danh sách thuốc của cửa hàng</li>
                    <li class="breadcrumb-item"><a href="#">Thêm thuốc mới</a></li>
                </ul>
            </div>
            <div class="row">
                <div class="col-md-12">
                    <div class="tile">
                        <h3 class="tile-title">Thêm thuốc mới</h3>
                        <div class="tile-body">
                            ...
                            <form action="add" method="post" class="row">
                                   <div class="form-group col-md-3">
                                    ...
                                    <input id="maThuoc" name="maThuoc" class="form-control" type="text" placeholder="T...">
                                </div>
                                <div class="form-group col-md-3">
                                ...
                                <div class="form-group col-md-12">
                                    <button id="btn_dbrr" class="btn btn-save" type="submit">Lưu lại</button>
                                    <a class="btn btn-cancel" href="/load">Hủy bỏ</a>
                                </div>
                            </form>
                        </div>
                    </div>
    ...
    <script>
        $(document).ready(() => {
            $('#btn_dbrr').click(e => {
                e.preventDefault();
                console.log($('#uploadfile').val().split('\\').pop())
                if (!$('#maThuoc').val() || !$('#name').val() || !$('#price').val() || !$('#uploadfile').val() || !$('#description').val()) {
            ...
            $("#uploadfile").change(e => {
                $('#nameImg').text($('#uploadfile').val().split('\\').pop())
            })
        })
